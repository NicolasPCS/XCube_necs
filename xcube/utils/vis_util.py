...
def vis_pcs(pcl_lst, S=3, vis_order=[2,0,1], bound=1):
    ...
    w, h = fig.canvas.get_width_height() # Added by Nicolás - Delete
    image_from_plot = image_from_plot.reshape((h, w, 4))[:, :, :3]#image_from_plot.reshape(fig.canvas.get_width_height()[::-1] + (3,))
